...
public class DirectionalTntBlock extends Block {
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        if (!world.isClient) {
            DirectionalTntEntity tntEntity = new DirectionalTntEntity(world, (double) pos.getX() + 0.5D, pos.getY(), (double) pos.getZ() + 0.5D, explosion.getCausingEntity());
    ...
    private static void primeTnt(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        if (!world.isClient) {
            DirectionalTntEntity tntEntity = new DirectionalTntEntity(world, (double) pos.getX() + 0.5D, pos.getY(), (double) pos.getZ() + 0.5D, igniter);
            world.spawnEntity(tntEntity);
